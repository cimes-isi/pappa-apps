...
#  MATLAB algorithm for spotlight processing and translated to Python.       #
#                                                                            #
##############################################################################
...
xn[2-1]=.7*X0;          yn[2-1]=-.6*Y0;       fn[2-1]=1.4;
xn[3-1]=0;              yn[3-1]=-.85*Y0;      fn[3-1]=.8;
...
for i in range(ny):                       # for each k loop
